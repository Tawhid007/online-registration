...
class SemestersControllerTest < ActionController::TestCase
  ...
  test "should create semester" do
    assert_difference('Semester.count') do
      post :create, semester: { semester_name: @semester.semester_name, semester_type: @semester.semester_type }
    end
  ...
  test "should update semester" do
    patch :update, id: @semester, semester: { semester_name: @semester.semester_name, semester_type: @semester.semester_type }
    assert_redirected_to semester_path(assigns(:semester))
  end
